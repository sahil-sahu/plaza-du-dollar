                    ...
                    <div className="bg-white rounded-lg shadow-lg p-8 text-center">
                        <div className="mb-6">
                            ...
                            <p className="text-lg text-gray-600">
                                Thank you for your order. Your Square payment has been processed successfully.
                            </p>
                        </div>
                        ...
                        <div className="flex items-center justify-center mb-6 text-blue-600">
                            ...
                            <span className="text-sm">Square payment processed successfully</span>
                        </div>

                        <div className="space-y-4">
                            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                                <h3 className="font-semibold text-blue-800 mb-2">Square Payment Confirmation:</h3>
                                <ul className="text-blue-700 text-sm text-left space-y-1">
                                    <li>• Your payment has been securely processed by Square</li>
                                    <li>• You will receive a Square receipt via email</li>
                                    <li>• Your order is now being processed for fulfillment</li>
                                </ul>
                            </div>
